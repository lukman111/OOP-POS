 ...
 * Demonstrates: Composition (it holds a list of MenuItem objects).
 */
public class Order {
    private final int orderId;
    // Composition: A list of CartItem objects (a simple inner class for quantity tracking)
    private List<CartItem> items;
    private String status;
    private static final double TAX_RATE = 0.08; // 8%

    // Simple inner class to handle the quantity of a MenuItem
    ...
    /**
     * Calculates the financial breakdown (subtotal, tax, total, and discount).
     */
